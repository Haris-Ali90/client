  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script> -->
    ...
    <div class="loader-iner-warp">
                        ...
                        <div  class="x_title2" id="fileupload">
                                    <!---x_title start-->
                                    <form action="{{ URL::to('custom/upload/file')}}" method="post" class="fileupload" enctype="multipart/form-data" >
...
//enableRouteOrder
 ...
 $(document).on('click','.enableRouteOrder',function(){
    ...
    $.each($("input[name='check']:checked"), function(){
        ...
        $.ajax({
              type: "post",
              url: "{{ URL::to('enable/order/forroute')}}",
...
$('.trackingidEbableRoute').submit(function(event) {
   ...
   event.preventDefault();
                       ...
                       $.ajax({
                                   url: "{{ URL::to('custom/enable/trackingid')}}",
                                   type: 'POST',
                                   contentType: false,
                                   processData: false,
                                   data:data,

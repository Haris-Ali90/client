...
@section('content')
    <div class="right_col" role="main">
        ...
        <div class="">
            ...
            <div class="row"><!---row-->
                        ...
                        <h1 style="position: relative;padding-right: 116px;"><b>Return Custom Routing </b> <button   style="background-color: #c6dd38;position: absolute;right: 0px;" data-id='{{$id}}'class='btn btn clearOrder' >Clear Order </button></h1>
    ...
    <div class="loader-iner-warp">
                        <div class="loader" style="display: none" ></div>
                                ...
                                <button style="background-color: #c6dd38;" class='btn btn addRow'>Add Joey Vehicle</button>
                           ...
                           <div class="x_content">
                                ...
                                <div class="x_title">   <!---x_title-->
                           <button type="button" class="btn btn-success btn-md"  style="float:right;margin-bottom: 10px;background-color: #c6dd38">Delete Record</button><br>

            ...
            <div class="inner">
                <div class="container xs">
                    ...
                    <div class="hgroup align-center seperator_center">
                        <h2>Trainings</h2>
                        <p>Short documents and videos will be available for guide user about the using of client portal</p>
                    </div>
                </div>
                <div class="container">
...
{{--                                                            class="flexbox flex-center jc-center f18"></span>--}}
{{--                                                </div>--}}
{{--                                                <div class="info">--}}
...
{{--                                        </div>--}}
                                        <div class="row_actions">
                                            <ul class="no-list">
                                                <li><a href="{{ $training->url }}"
                                                       class="btn btn-bc1lightest no-radius full-w no-shadow"><span
                                                                class=""></span>{{ $training->title }}</a></li>
{{--                                                <li><a href="{{url('microhub/training-documents/'.base64_encode($training->id))}}"--}}
{{--                                                       class="btn btn-bc1lightest no-radius full-w no-shadow"><span--}}

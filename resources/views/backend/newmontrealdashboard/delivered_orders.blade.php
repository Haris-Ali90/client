    ...
    <script>
        $(function() {
            var table = $('.yajrabox').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('newmontrealDelivered.data') }}",
                columns: [{
                        data: 'sprint_id',
                        orderable: true,
                        searchable: true,
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left"> 
                    <h3 class="text-center">Delivered Order<small></small></h3>
                </div>
            </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                            ...
                            <form method="get" action="">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 sm_custm">
                                        ...
                                        @endif
                                        <div class="excel-btn" style="float: right">
                                            <a href="{{route('newmontreal-delivered.index')}}"
                        ...
                        <div class="x_content">
                                ...
                                <tbody>
                                    ...
                                    @forelse($query as $index => $order)
                                        <tr>
                                            ...
                                            <td>{{ isset($status_code[$order->task_status_id])==1?$status_code[$order->task_status_id]:''  }}</td>
                            ...
                            <div class="col-md-12 t-em">
                                @if ($query->isEmpty())
                                <p class="data_not t-em" >    No data available in table
                                </p>
                                @endif
                                {!! $query->links() !!}
                            </div>

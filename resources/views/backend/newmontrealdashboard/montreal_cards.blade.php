        ...
        <!--Animated-a Div Open-->
            ...
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <div class="tile-stats">
                    ...
                    <div class="count" id="total_orders">{{$query->total()}}
   ...
   {{-- @if(in_array($type, ['all','manifest']))
    ...
    @if(in_array($type, ['all','return']))
        <!--Animated-c Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <div class="tile-stats">
                    ...
                    <div class="count" id="return_orders">{{$query->total()}}
        ...
        @if(in_array($type, ['all','yesterday']))
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                <!--dashbords-conts-tiles-loader-main-wrap-open-->
                <div class="dashbords-conts-tiles-loader-main-wrap  yesterday-order">
                    <div class="dashbords-conts-tiles-loader-inner-wrap">
                        <div class="lds-roller">
                            <div class="dot-1"></div>
                            <div class="dot-2"></div>
        ...
        <!--Animated-e Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <div class="tile-stats">
                    ...
                    <div class="count" id="picked_orders">{{$query->total()}}
        ...
        <!--Animated-f Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <div class="tile-stats">
                    ...
                    <div class="count" id="delivered_orders">{{$query->total()}}
        ...
        <!--Animated-g Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <div class="tile-stats">
                    ...
                    <div class="count" id="notscan_orders">{{$notscan}}
            ...
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <a href="<?php echo URL::to('/'); ?>/reporting/not/scan?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=scan">
                    <div class="tile-stats">
                        ...
                        <div class="count" id="reattempted_orders">{{$reattempted}}
                        </div>{{--{{ isset($amazon_count)?$amazon_count['notscan']:0  }}</div>--}}
        ...
        <!--Animated-h Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                <!--dashbords-conts-tiles-loader-main-wrap-open-->
                <div class="dashbords-conts-tiles-loader-main-wrap  failed-order">
                    <div class="dashbords-conts-tiles-loader-inner-wrap">
                        <div class="lds-roller">
                            <div class="dot-1"></div>
                            <div class="dot-2"></div>
        ...
        <!--Animated-h Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                <!--dashbords-conts-tiles-loader-main-wrap-open-->
                <div class="dashbords-conts-tiles-loader-main-wrap  custom-route">
                    <div class="dashbords-conts-tiles-loader-inner-wrap">
                        <div class="lds-roller">
                            <div class="dot-1"></div>
                            <div class="dot-2"></div>
...
@endif
    @if(in_array($type, ['all']))
        <!--Animated-a Div Open-->
            ...
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                <!--dashbords-conts-tiles-loader-main-wrap-open-->
                <div class="dashbords-conts-tiles-loader-main-wrap  total-summary">
                    <div class="dashbords-conts-tiles-loader-inner-wrap">
                        <div class="lds-roller">
                            <div class="dot-1"></div>
                            <div class="dot-2"></div>

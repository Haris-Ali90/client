...
<!-- <script type="text/javascript">
   $( function() {
    ...
    function fullmap() {
        ...
        $.ajax({
            url: '{{backend_url("allroute/477282/location/joey?date=".$date."")}}',
            type : 'GET',
            dataType:'json',
            success : function(data) {
                console.log(data);
    ...
    $(document).on('click', '.details', function(e) {
        ...
        $.ajax({
            url: '{{backend_url("returnroute/")}}/'+routeId+'/details',
            type: 'GET',
            dataType: 'json',
            success: function(data) {
                var i = 0;
    ...
    $(function() {
        $(document).on('click', '.delete', function(e) {
            ...
            if (x) {
                ...
                $.ajax({
                    type: "GET",
                    url: '{{backend_url("returnroute/")}}/'+del_id+'/delete/hub',
/*                    url: '../route/' + del_id + '/delete/hub',*/
        ...
        $(document).on('click', '.reroute', function(e) {
            ...
            if(x){
                ...
                $.ajax({
                    type: "GET",
                    url: '{{backend_url("hub/19/re-route/")}}/'+del_id,
    ...
    function pageReload() {
        ...
        //$(function () {
            appConfig.set('yajrabox.ajax', '{{ route('ottawa-routing.data') }}');
            ...
            appConfig.set('yajrabox.columns', [
                ...
                {data: 'zone', orderable: true,   searchable: true, className:'text-center'},
    ...
    <div class="modal-body">
        ...
        <div class='modal-content'>
            ...
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <select id="joey_id" multiple name="joey_id" class="form-control s" >
                    <?php

        ...
        <div class="">
                    ...
                    <div class="top_tiles col-md-12 montreal-dashbord-tiles" id="montreal-dashbord-tiles-id">
                        ...
                        <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 ">
                            <div class="tile-stats">
                                ...
                                <div class="count">
                                    <?php 
                                    if (empty($amazoncounts[0]->total_count)) 
                                    {
                                       echo "0";
                                    }
                                    else
                                    {
                                        echo  $amazoncounts[0]->total_count;
                                    }  
                                    ?>              
                                 </div>
                                <h3>Total Orders</h3>
                        ...
                        <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 ">
                            <div class="tile-stats">
                                ...
                                <div class="count">
                                <?php
                                if (empty($amazoncounts[0]->not_in_route)) 
                                {
                                    echo "0";
                                } 
                                else
                                {
                                    echo $amazoncounts[0]->not_in_route;
                                }
                                ?>                 
                                </div>
                                <h3> Not Scan</h3>
           ...
           foreach ($routes as $route) {
               ...
               echo "<td><button class='details green-gradient btn' data-route-id=" . $route->route_id . " data-joey-id=" . $route->joey_id . " title='Details'>D</button>
                <a class=' orange-gradient btn' target='_blank' href='../returnroute/" . $route->route_id . "/edit/hub/19' title='Edit Route'>E</a>
                ...
                <a class=' orange-gradient btn' target='_blank' href='../routific/route/" . $route->route_id . "/history' title='Route History'>RH</a>
                </td>";
               echo "</tr>";
               $j++;
               $i++;
        ...
        <div class='modal-dialog'>
            <div class='modal-content'>
                ...
                <select id="slots" multiple class="form-control chosen-select" name="slots[]"  requried style="width: 100%;">
                    <?php 
                    $slots =  Slots::where('hub_id','=',19)->get();
      ...
      function fullmap() {
          ...
          <?php    if(empty($_REQUEST['date'])){
                      ...
                      $.ajax({
                          ...
                          url : '../../allroute/477282/location/joey?date=<?php echo $date; ?>',
                          type : 'GET',
                          dataType:'json',
                          success : function(data) {
                              console.log(data);

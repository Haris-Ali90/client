    ...
    <div class="row" id="montrealCards">
        <div class="top_tiles col-md-12 montreal-dashbord-tiles" id="montreal-dashbord-tiles-id">
            ...
            <div class="clearfix"></div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                   ...
                   <table id="datatable" class="table table-striped table-bordered">
                                ...
                                foreach ($routes as  $route) {
                                    echo "<tr class='route-tbl-tr-".$route->route_id.".'>";
                                    echo "<td>" . $i . "</td>";
                                    echo "<td>R-" . $route->route_id . "</td>";
                                    echo "<td>" . $counts[$j]->zone . "</td>";
                                    echo "<td>" . $route->joey_id . "</td>";
                                    echo "<td class='routes-td-joye-name'>" . $route->first_name . ' ' . $route->last_name . "</td>";
                ...
                <a class=' orange-gradient btn' target='_blank' href='../returnroute/" . $route->route_id . "/edit/hub/16' title='Edit Route'>E</a>
...
function fullmap() {
    ...
    <?php    if(empty($_REQUEST['date'])){
                ...
                $.ajax({
                    ...
                    url : '../../allroute/477260/location/joey?date=<?php echo $date; ?>',
                    type : 'GET',
                    dataType:'json',
                    success : function(data) {
                        console.log(data);

            ...
            <div class="clearfix"></div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                        <a class="btn green-gradient" href="{{ backend_url('return/routes') }}"></i>Actual Routes</a>
            ...
            <div class='modal-content'>
                ...
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <select id="zone" multiple class="form-control chosen-select" name="zone[]" requried style="width: 100%;">
                        <?php 
                        $zones =  RoutingZones::where('hub_id','=',17)->whereNull('deleted_at')->get();

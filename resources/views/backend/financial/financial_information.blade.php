                ...
                <div class="portlet-body libs_customimize">
                    ...
                    <form method="POST" action="{{ route('subAdmin.create') }}" class="form-horizontal usCustomForm"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number" name="email" maxlength="32" value="{{ old('email') }}"
                        ...
                        <div class="form-group">
                            <label for="phone" class="col-md-2 control-label">Expiration Month *</label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number" id="potalCoode" name="password" minlength="6" maxlength="32"
                                       class="form-control" required/>
                            </div>
                        </div>

                        <div class="form-group form-check">
                            <label for="password" class="col-md-2 control-label">Ceck As Primary </label>
                            <div class="col-md-12">

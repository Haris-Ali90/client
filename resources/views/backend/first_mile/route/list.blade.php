        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <form id="filter" style="" action="" method="get">
                            <div class="col-lg-3">
...
//                                            $vendorOrderCount = $vendor->getVendorOrdersCount(date("Y-m-d", strtotime($route->date)));
...
{{--                                            <td>{{ $vendorOrderCount }}</td>--}}
                                            ...
                                            <td>
                                                ...
                                                <a class=' orange-gradient btn control-size' target='_blank' href='../../../first/mile/route/{{$route->route_id}}/edit/hub/17?date={{$date}}' title='Edit Route'>E</a>

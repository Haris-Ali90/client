...
$(function() {
    ...
    if (window.location.href.indexOf('?date=') != -1) {
        url=window.location.href.replace("label-order/index?date=", "label-order-data/")
    }else{
        url=window.location.href.replace("label-order/index", "label-order-data/"+jQuery('[name=date]').val())
    }
console.log(url)
    // console.log("https://smrtesting.com/ksa/client/public/label-order-data/"+jQuery('[name=date]').val())
            var table = $('.yajrabox').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'joey_id',  "defaultContent": "",// joey_name
                        orderable: true,
                        searchable: false
                    },
                    {
                        data: 'creator_type',// customer address
                        orderable: true,
                        searchable: true,
                        className: 'text-center'
                    },
                        ...
                        <div class="x_content">
                            ...
                            <div class="table-responsive">
                                <div class="x_title">   <!---x_title-->
                                    ...
                                    <button type="button" class="btn btn-warning btn-md print-label sub-ad c-color"  style="float:right;margin-bottom: 10px;">Print Selected</button><br>

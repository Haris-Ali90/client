        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panell">
                        <div class="x_title">
                            @if(can_access_route(['micro-hub-slot-create.post'],$userPermissoins))

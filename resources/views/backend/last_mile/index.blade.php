                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6 text-right p_top sm_custm">
{{--                                    @if(can_access_route(['micro-hub-zones-create.post'],$userPermissoins))--}}
                                        <button style="margin-left:10px;" class="btn green-gradient" data-toggle="modal"
                                                data-target="#ex1"><i class="fa fa-plus"></i> Create Zone
                                        </button>
{{--                                    @endif--}}
{{--                                    @if(can_access_route(['micro-hub-total-order-notinroute.post'],$userPermissoins))--}}
                                        <button data-id='{{$id}}' class='btn green-gradient totalOrderCount'>Total Order
                                            Count
                                        </button>
{{--                                    @endif--}}
                                </div>
...
//                                        if (can_access_route(['micro-hub-zones-count.get', 'micro-hub-ottawa-routes-add.post', 'micro-hub-montreal-routes-add.post', 'micro-hub-ctc-routes-add.post'], $userPermissoins)) {
                                            echo "<button type='button'  class='counts btn btn orange-gradient actBtn small_btn'  data-id='" . $zones->id . "'>Count<i class='fa fa-eye'></i></button>";
//                                        }
...
//                                        if (can_access_route(['micro-hub-slot-list-hubid.get'], $userPermissoins)) {
                                            echo "<a href='slots/list/hubid/" . $zones->hub_id . "/zoneid/" . $zones->id . "' class='btn btn orange-gradient actBtn small_btn'>View Slots <i class='fa fa-eye'></i></button>";
//                                        }
                                        echo "</td>";
                                        echo "</tr>";
                                        $i++;

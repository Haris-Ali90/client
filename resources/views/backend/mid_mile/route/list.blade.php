...
{{--                                        <th>Hub Orders Count</th>--}}
                                    ...
                                    @foreach($routes as $key => $route)
                                        <?php
//                                            $hub = \App\Hub::find($route->task_id);
//                                            $hubOrderCount = $hub->getHubOrdersCount($date, $hub->id);
...
{{--                                            <td>{{ $hubOrderCount }}</td>--}}
                                            ...
                                            <td>
                                                ...
                                                <a class=' orange-gradient btn control-size' target='_blank' href='../../../mid/mile/route/{{$route->route_id}}/edit/hub/17?date={{$date}}' title='Edit Route'>E</a>
    ...
    <script>
        ...
        $(document).on('click', '.details', function(e) {
            ...
            $.ajax({
                ...
                url: '../../../mid/mile/route/' +  routeId + '/details?date=' + date,
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    var i = 0;

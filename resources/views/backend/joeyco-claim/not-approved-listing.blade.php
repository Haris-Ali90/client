            ...
            @endif
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                        <button  type='button' onclick="exportTableToCSV('JoeyCo-Claims-Not-Approved-List.csv')"  class='btn blue btn green-gradient'>Generate Report in CSV</button>
                    </div>
                </div>
                <br>

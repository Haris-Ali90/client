                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="x_title">
                                <form method="get" action="" id="searchform">
                                    ...
                                    <div class="col-md-2">
                                        <button class="btn blue btn green-gradient"  type="button"  onclick="checkDateDiff()" style="margin-top: 25px">Go</a> </button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                ...
                                @endif
                                <button  type='button' onclick="exportTableToCSV('JoeyCo-Claims-Pending-List.csv')"  class='btn blue btn green-gradient'>Generate Report in CSV</button>
                            </div>
                        </div>
                        <br>
                            ...
                            <div class="portlet-body">
                                <table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 5% !important;"  class="text-center ">Joey #</th>
                                        <th style="width: 10% !important;"  class="text-center ">Joey Name</th>

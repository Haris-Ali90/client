        ...
        <div class="">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-edit"></i> Edit Sub Admin
                    </div>
                </div>
                ...
                <div class="portlet-body">
                    ...
                    <form method="POST" action="{{ route('subAdmin.update', $user->id) }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="full_name" class="col-md-2 control-label">First Name *</label>
                            <div class="col-md-4">
                                <input type="text" name="full_name" maxlength="150" value="{{ old('full_name', $user->full_name) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select class="form-control col-md-7 col-xs-12 role-type js-example-basic-multiple" name="hubPermission[]" multiple required>
                                    <option value="">Select an option</option>

                                    @foreach($hubProcess as $processType)
                                        <option value="{{$processType->id}}">{{$processType->deliveryProcess->process_title}}</option>
                                    @endforeach
                                </select>
                            </div>
                            @if ($errors->has('role'))
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <div class="col-md-4">
                                    {{ Form::file('profile_picture', ['class' => 'form-control ','onchange'=>"checkFileExtension(this)"]) }}
                                    <img style="max-width: 350px;height: 150px;margin-top: 4px" onClick="preview(this);"  src="{{$user->profile_picture}}" />

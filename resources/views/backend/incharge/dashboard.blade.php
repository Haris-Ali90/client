        ...
        <div class="dashboard_pg">
            ...
            @else
                ...
                <div class="step_formRow">
                    ...
                    <div class="arrowCol">
                        <div class="stats_box step_formcol">
                            <h6>Last-Mile Written & Recive</h6>
                            <img src="<?php echo e(asset('images/joey_icon.png')); ?>">
                        </div>
                    </div>
                </div>
                ...
                <!-- First Mile Section Ends here-->


                <!-- Mid Mile Section Starts -->
                <div class="stats section">
                    <!-- Featured numbers - [start] -->
                    <h2>Mid Mile</h2>
                    <div class="featured_numbers statistics">
                ...
                <!-- Mid Mile Section Ends here-->


                <!-- Last Mile Section Starts -->
                <div class="stats section">
                    <!-- Featured numbers - [start] -->
                    <h2>Last Mile</h2>
                    <div class="featured_numbers statistics">
    ...
    <script>
        ...
        $(function(){
            ...
            function getOTDYear(value) {
                ...
                $.ajax({
                    type: "GET",
                    url: "<?php echo URL::to('incharge/'); ?>/statistics/year/otd",
                    data: {'datepicker': selected_date, 'hub_id': selected_hub},
                    /* beforeSend: function (xhr) {
                         xhr.overrideMimeType("text/plain; charset=x-user-defined");
                     },*/
...
//
            ...
            function GetMidMileOrder() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        total_order.innerHTML = data['total_orders'];
                        // total_vendors.innerHTML = data['total_orders'];
                        collected_order.innerHTML = data['collected_orders'];
                        remaining_order.innerHTML = data['my_orders_at_otherhub'];
                        total_routes.innerHTML = data['routes'];
                        total_joeys.innerHTML = data['joeys'];
                        other_order.innerHTML = data['other_order_at_myhub'];
                        remaincc_order.innerHTML = data['dropped_cc_orders'];
                        pickcc_order.innerHTML = data['picked_cc_orders'];
            ...
            //     $('#hub-selector-click').on('click', function() {
            //
            //         let hub_id = $('.hub-selector').val();
            //         getOTDDay(hub_id);
            //         getOTDWeek(hub_id);
            //         getOTDMonth(hub_id);
            //         getOTDYear(hub_id);
            //         getTotalOrderDataCount(hub_id);
            //         getInprogressOrderDataCount(hub_id);
            //         getFailedOrderDataCount(hub_id);
            //         getCustomOrderDataCount(hub_id);
            //         getManualOrderDataCount(hub_id);
            //         getOnTimeCounts(hub_id);
            //         topbrookers(hub_id);
            //         topPerformers(hub_id);
            //         leastPerformers(hub_id);
            //         getgraph('week',hub_id);
            //         getRouteDataCounts(hub_id);
            //         GetFirstMileOrder(hub_id);
            //         GetMidMileOrder(hub_id);
            //         GetLastMileOrder(hub_id);
            //     });
            //
        })
        ...
        //     let test_value = $('.hub-selector').val();

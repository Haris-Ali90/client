...
### ajax based file download route
    ...
    Route::get('redirect/{driver}', 'Auth\AuthController@redirectToProvider');
    ...
    Route::get('signup', 'Auth\AuthController@signup')->name('sign_up');
    Route::post('signup', 'Auth\AuthController@signupPost')->name('sign_up_post');
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::get('step-form', 'StepFormController@index')->name('step.form');
        Route::post('step-form/save_data', 'StepFormController@save_data')->name('step.form.save.data');
        ...
        Route::get('incharge/statistics/day/otd', 'InchargeDashboardController@getDayOtd');
        Route::get('incharge/statistics/week/otd', 'InchargeDashboardController@getWeekOtd');
        Route::get('incharge/statistics/month/otd', 'InchargeDashboardController@getMonthOtd');
        Route::get('incharge/statistics/year/otd', 'InchargeDashboardController@getYearOtd');
        ...
        Route::get('date/reporting', 'NewMontrealController@getMontreal')->name('date.reporting');
        Route::get('date/sorting', 'NewMontrealController@getSorter')->name('date.sorting');
        ...
        Route::get('order-processing', 'NewMontrealController@OrderNotification')->name('order.processing');
        Route::get('delay-order', 'NewMontrealController@OrderNotification')->name('delay.order');
        Route::get('montreal/Delayorder/data', 'MontrealController@montrealDelayorder')->name('montrealDelayorder.data');
...
## DNR Report ##
        ...
        Route::post('mid/mile/mi/job/create/job', 'MidMileController@createJob')->name('mid.mile.mi.job.create.job');
        // delete mi job
...
//        Route::get('adminupdate/{user}', 'SubadminController@adminupdate');
        ...
        ###Client Reporting Dashboard Work Routes###
        ### CSV uploader
        Route::get('custom-run/csv-uploader', 'CsvUploaderController@getIndex');
        Route::post('csv/uploader', 'WalmartController@csv_uploader')->name('csv.uploader');
        
        //Order Labeling Routes
        Route::get('label-order/index', 'OrderLabelController@getOrderLabelIndex')->name('label-order.index');
        Route::get('label-order-data/{date}', 'OrderLabelController@getOrderLabelData')->name('label-order.data');
        Route::get('label-order/{id}', 'OrderLabelController@labelOrderPrint')->name('label-order.printLabel');
        Route::get('order/list', 'OrderLabelController@orderList')->name('order.list');
        Route::get('order/show/{id}', 'OrderLabelController@orderShow')->name('order.show');
		###Client Setting###
        ...
        Route::get('profile-setting/{id}','ClientSettingController@profileCreate')->name('profile.create');
        Route::post('profile-setting', 'ClientSettingController@profileStore')->name('profile.store');
        Route::get('account-setting/{id}', 'ClientSettingController@accountCreate')->name('account.store');
        Route::post('account-setting', 'ClientSettingController@accountStore')->name('account.store');

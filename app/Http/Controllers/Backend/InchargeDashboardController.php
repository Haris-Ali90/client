...
//                $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
            ...
            if($hub == "all") {
                ...
                $date = $request->get('datepicker') ? $request->get('datepicker') : date('Y-m-d');
                $vendors_data = FinanceVendorCityDetail::whereIn('vendor_city_realtions_id', $assigned_hub)->pluck('vendors_id')->toArray();
                $ctcVendorIds = CtcVendor::pluck('vendor_id')->toArray();
                $sprint = new Sprint();
...
//                        $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
                ...
                if (count(array_intersect($ctcVendorIds, $vendors_data))> 0) {
                    $ctc_ids = array_intersect($ctcVendorIds, $vendors_data);
                    $ctc_date  = date('Y-m-d', strtotime($date . ' -1 days'));
...
//                    $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
    ...
    public function getInprogress(Request $request)
    {
        ...
        if( $user->userType == 'user'){ //User Data to get the logged in details...
...
//            // $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
            ...
            $Remaining_order = TorontoEntries::whereIn('creator_id', $vendors_data)->whereIn('task_status_id',[147])->where('created_at','>',$start)->where('created_at','<',$end)
                ->where('is_custom_route', 0)->get();

            $Picked_id = TorontoEntries::whereIn('creator_id', $vendors_data)
            ...
            $Picked_order = TaskHistory::whereIn('sprint_id', $Picked_id)
                ->whereIn('status_id',[124])
                ->get();

            $Total_routes = JoeyRoute::where('hub',$user->hub_id)->where('mile_type',1)->where('date','>',$start)->where('date','<',$end)->pluck('joey_id')->toArray();
...
//                //$amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
                ...
                $Total_joeys = JoeyRoute::whereIn('hub',$assigned_hub)
                    ->where('mile_type',1)
                    ->pluck('joey_id')
                    ->groupBy('joey_id')
                    ->toArray();
...
//                $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
                ...
                $Total_joeys = JoeyRoute::where('hub',$input['hub_id'])
                    ->where('mile_type',1)
                    ->pluck('joey_id')
                    ->groupBy('joey_id')
                    ->toArray();
...
//                $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
                ...
                $Total_order = TorontoEntries::whereIn('creator_id', $vendors_data)
                    ->where('is_custom_route', 0)->get();
...
//                $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
                ...
                $Remaining_order = TorontoEntries::whereIn('creator_id', $vendors_data)->whereNotIn('task_status_id',[147])->where('created_at','>',$start)->where('created_at','<',$end)
                    ->where('is_custom_route', 0)->get();
...
//                $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
    ...
    public function getFirstMileRoutes(Request $request)
    {
        ...
        if( $user->userType == 'user'){
            $Total_routes = JoeyRoute::where('hub',$user->hub_id)->where('mile_type',1)->where('date','>',$start)->where('date','<',$end)->get();
            ...
            if($hub == "all") {
                ...
                $Total_routes = JoeyRoute::whereIn('hub',$assigned_hub)->where('mile_type',1)->get();
                return backend_view('incharge.total_routes', compact('Total_routes'));

            }else{

                $Total_routes = JoeyRoute::where('hub',$hub)->where('mile_type',1)->get();
                return backend_view('incharge.total_routes', compact('Total_routes'));
    ...
    public function getFirstMileJoeys(Request $request)
    {
        ...
        if( $user->userType == 'user'){
            ...
            if($hub == "all") {
                ...
                $Total_joeys = JoeyRoute::where('hub',$hub)
                    ->where('mile_type',1)
                    ->groupBy('joey_id')
                    ->get();
                return backend_view('incharge.total_joeys', compact('Total_joeys'));
    ...
    public function MidMileDetails(Request $request)
    {
        ...
        if( $user->userType == 'user'){
            ...
            $Total_order = MicroHubOrder::where('hub_id', $user->hub_id)
                ->where('created_at','>',$start)
                ->where('created_at','<',$end)
                ->get();


            $MyOrders_at_Other_Hub = MicroHubOrder::where('is_my_hub', 0)
            ...
            $Other_Orders_at_Myhub = MicroHubOrder::where('is_my_hub', 1)
                ->where('hub_id', $user->hub_id)
                ->where('created_at','>',$start)
                ->where('created_at','<',$end)
                ->pluck('sprint_id')
            ...
            $Picked_Orders = TaskHistory::whereIn('sprint_id', $Sprint_ids)
                ->where('status_id',149)
                ->get();
...
//                $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
                ...
                $Total_order = MicroHubOrder::whereIn('hub_id', $assigned_hub)
                    ->where('created_at','>',$start)
                    ->where('created_at','<',$end)
                    ->get();
                ...
                $Total_routes = JoeyRoute::whereIn('hub',$assigned_hub)
                    ->where('mile_type',2)
                    ->pluck('joey_id')
                    ->toArray();
...
//                $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
                ...
                $Total_order = MicroHubOrder::where('hub_id', $input['hub_id'])
                    ->where('created_at','>',$start)
                    ->where('created_at','<',$end)
                    ->get();
                ...
                $Total_routes = JoeyRoute::where('hub_id', $input['hub_id'])
                    ->where('mile_type',2)
                    ->pluck('joey_id')
                    ->toArray();

                $Total_joeys = JoeyRoute::where('hub_id', $input['hub_id'])
                    ->where('mile_type',2)
                    ->pluck('joey_id')
                    ->groupBy('joey_id')
                    ->toArray();
...
//            $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
            ...
            $Total_order = CTCEntry::whereIn('sprint_id',$Total_order_id)
                ->get();
...
//                $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
                ...
                $Total_order_id = MicroHubOrder::whereIn('hub_id', $assigned_hub)
                    ->where('created_at','>',$start)
                    ->where('created_at','<',$end)
                    ->pluck('sprint_id')
                    ->toArray();
...
//                $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
                ...
                $Total_order_id = MicroHubOrder::where('hub_id', $input['hub_id'])
                    ->where('created_at','>',$start)
                    ->where('created_at','<',$end)
                    ->pluck('sprint_id')
                    ->toArray();
...
//            $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
            ...
            $Picked_order = TaskHistory::whereIn('sprint_id', $Sprint_ids)
                ->where('status_id',149)
                ->get();
...
//            $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
            ...
            $Sprint_ids = MicroHubOrder::where('is_my_hub', 0)
                ->where('hub_id', $user->hub_id)
                ->where('created_at','>',$start)
                ->where('created_at','<',$end)
                ->pluck('sprint_id')
            ...
            $Remaining_order = TaskHistory::whereIn('sprint_id', $Sprint_ids)
                ->where('status_id',148)
                ->get();
...
//            $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
            ...
            $Sprint_ids = MicroHubOrder::where('is_my_hub', 1)
                ->where('hub_id', $user->hub_id)
                ->where('created_at','>',$start)
                ->where('created_at','<',$end)
                ->pluck('sprint_id')
            ...
            $Other_order = TaskHistory::whereIn('sprint_id', $Sprint_ids)
                ->where('status_id',148)
                ->get();
...
//                $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
    ...
    public function getMidMileRoutes(Request $request)
    {
        ...
        if( $user->userType == 'user'){
            $Total_routes = JoeyRoute::where('hub',$user->hub_id)->where('mile_type',2)->get();
            ...
            if($hub == "all") {
                ...
                $Total_routes = JoeyRoute::where('hub',$assigned_hub)->where('mile_type',2)->get();
                return backend_view('inchargemidmile.total_routes', compact('Total_routes'));

            }else{

                $Total_routes = JoeyRoute::where('hub',$hub)->where('mile_type',2)->get();
                return backend_view('inchargemidmile.total_routes', compact('Total_routes'));
    ...
    public function getMidMileJoeys(Request $request)
    {
        ...
        if( $user->userType == 'user'){
            ...
            if($hub == "all") {
                ...
                $Total_joeys = JoeyRoute::where('hub',$assigned_hub)
                    ->where('mile_type',2)
                    ->groupBy('joey_id')
                    ->get();
                return backend_view('inchargemidmile.total_joeys', compact('Total_joeys'));
...
//            $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
            ...
            $Total_order = $this->getLastMileTotalOrder($user->hub_id,$all_status_ids,$start,$end);


            $complete_status = [17, 113, 114, 116, 117, 118, 132, 138, 139, 144];
            $completed_order = $this->getLastMileTotalOrder($user->hub_id,$complete_status,$start,$end);

            $return_status = [101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 112, 113, 131, 135, 136, 143];
            $return_order = $this->getLastMileTotalOrder($user->hub_id,$return_status,$start,$end);

            $unattempt_status = [13, 61, 124];
            $unattempted_order = $this->getLastMileTotalOrder($user->hub_id,$unattempt_status,$start,$end);

            $sort_status = [133];
            $sorted_order = $this->getLastMileTotalOrder($user->hub_id,$sort_status,$start,$end);

            $pickup_status = [121];
            $pickedup_order = $this->getLastMileTotalOrder($user->hub_id,$pickup_status,$start,$end);

            $delay_status = [255];
            $delayed_order = $this->getLastMileTotalOrder($user->hub_id,$delay_status,$start,$end);

            $Total_routes = JoeyRoute::where('hub',$user->hub_id)->where('mile_type',3)->pluck('joey_id')->toArray();
            $Total_joeys = JoeyRoute::where('hub',$user->hub_id)
                ->where('mile_type',3)
                ->pluck('joey_id')
                ->groupBy('joey_id')
            ...
            $Custom_order = $this->getLastMileCustom($user->hub_id,$start,$end);
            $lastmiledata = [
...
//                $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
                ...
                $Total_routes = JoeyRoute::where('hub',$assigned_hub)->where('mile_type',3)->pluck('joey_id')->toArray();
                $Total_joeys = JoeyRoute::where('hub',$assigned_hub)
                    ->where('mile_type',3)
                    ->pluck('joey_id')
                    ->groupBy('joey_id')
...
//                $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
                ...
                $Total_routes = JoeyRoute::where('hub',$input['hub_id'])->where('mile_type',3)->pluck('joey_id')->toArray();
                $Total_joeys = JoeyRoute::where('hub',$input['hub_id'])
                    ->where('mile_type',3)
                    ->pluck('joey_id')
                    ->groupBy('joey_id')
...
//                $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
    ...
    public function getLastMileTotalOrder($hub,$status,$start,$end){


        $My_total_sprint = MicroHubOrder::whereIn('hub_id', [$hub])
            ->where('is_my_hub',1)
            ->where('created_at','>',$start)
            ->where('created_at','<',$end)
            ->pluck('sprint_id')
        ...
        $My_total_order = TaskHistory::whereIn('sprint_id', $My_total_sprint)
    ...
    public function getLastMileCustom($hub,$start,$end){
        ...
        $My_total_order = CTCEntry::whereIn('sprint_id', $My_total_sprint)
...
//            $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
            ...
            $Picked_order = $this->getLastMileTotalOrder($user->hub_id,$pickup_status,$start,$end);
...
//            $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
            ...
            $Picked_order = $this->getLastMileTotalOrder($user->hub_id,$complete_status,$start,$end);
...
//            $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
            ...
            $Picked_order = $this->getLastMileTotalOrder($user->hub_id,$return_status,$start,$end);
...
//            $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
            ...
            $Picked_order = $this->getLastMileTotalOrder($user->hub_id,$unattempt_status,$start,$end);
...
//            $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
            ...
            $Picked_order = $this->getLastMileTotalOrder($user->hub_id,$sort_status,$start,$end);
...
//            $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
            ...
            $Picked_order = $this->getLastMileTotalOrder($user->hub_id,$delay_status,$start,$end);
...
//            $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
            ...
            $Picked_order = $this->getLastMileCustom($user->hub_id,$start,$end);
...
//                $amazon_date = date('Y-m-d', strtotime($date . ' -1 days'));
    ...
    public function getLastMileRoutes(Request $request)
    {
        ...
        if( $user->userType == 'user'){
            $Total_routes = JoeyRoute::where('hub',$user->hub_id)->where('mile_type',3)->get();
            ...
            if($hub == "all") {
                ...
                $Total_routes = JoeyRoute::where('hub',$hub)->where('mile_type',3)->get();
                return backend_view('inchargelastmile.total_routes', compact('Total_routes'));
